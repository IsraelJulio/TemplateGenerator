...
/// <summary>
/// O registro da persistência em PostgreSQL, em um lugar só.
/// </summary>
/// <remarks>
        ...
        string? connectionString)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            throw new InvalidOperationException(
                ...
                "Defina-a em appsettings.json ou na variável de ambiente " +
                "'ConnectionStrings__Default'; o README explica os dois caminhos.");
        }
