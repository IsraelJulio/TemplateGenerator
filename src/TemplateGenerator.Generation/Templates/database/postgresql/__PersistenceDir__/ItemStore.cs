...
/// <summary>
/// Armazenamento de <see cref="Item"/> em <strong>PostgreSQL</strong>, sobre EF Core.
/// </summary>
/// <remarks>
/// <para>
/// O servidor é o apontado pela cadeia de conexão <c>Default</c>. Diferente do armazenamento em
/// memória, <strong>os dados sobrevivem ao reinício</strong> da aplicação — e, aqui, também à
/// troca da máquina que roda a aplicação.
/// </para>
/// <para>
